...
def evalintersectionAndUnion(output, target, K, ignore_index=255, evaluator=None):
    ...
    evaluator.add(outputs=output.flatten(), targets=target.flatten())
    return evaluator.cache_exists
...
def cal_acc(data_list, pred_folder, classes, names):
    ...
    evaluator = ADE20KEvaluator(model_name='PSPNet (ResNet-50)', paper_arxiv_id='1612.01105')
